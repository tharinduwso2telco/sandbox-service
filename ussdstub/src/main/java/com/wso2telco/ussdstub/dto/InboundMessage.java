...
/**
 * The Class InboundMessage.
 */
public class InboundMessage {
    
    /** The inbound ussd message request. */
    private InboundUSSDMessageRequest inboundUSSDMessageRequest;

    /**
     * Gets the inbound ussd message request.
     *
     * @return the inbound ussd message request
     */
    ...
    /**
     * Sets the inbound ussd message request.
     *
     * @param inboundUSSDMessageRequest the new inbound ussd message request
     */
