...
public class RemoveProvisionedServicesResponseWrapper extends AbstractReturnWrapperDTO {
	...
	private RemoveProvisionedResponseBean removeProvisionResponseBean = null;

	public RemoveProvisionedResponseBean getRemoveProvisionedResponseBean() {
		return removeProvisionResponseBean;
	}

	public void setRemoveProvisionedResponseBean(
			RemoveProvisionedResponseBean removeProvisionResponseBean) {
		this.removeProvisionResponseBean = removeProvisionResponseBean;
	}
