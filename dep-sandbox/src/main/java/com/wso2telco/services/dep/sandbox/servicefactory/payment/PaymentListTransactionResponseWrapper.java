...
public class PaymentListTransactionResponseWrapper extends AbstractReturnWrapperDTO {

    private PaymentListTransactionDTO listPaymentDTO;
    ...
    public PaymentListTransactionDTO getListPaymentDTO() {
        return listPaymentDTO;
    }

    public void setListPaymentDTO(PaymentListTransactionDTO listPaymentDTO) {
