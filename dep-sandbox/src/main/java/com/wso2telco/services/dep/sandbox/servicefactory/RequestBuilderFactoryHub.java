...
import com.wso2telco.services.dep.sandbox.servicefactory.smsmessaging.hub.SMSRequestFactoryHub;
import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;

public class RequestBuilderFactoryHub {


    static Log LOG = LogFactory.getLog(RequestBuilderFactoryHub.class);
    ...
    public static RequestHandleable getInstance(final RequestDTO requestDTO) {
        ...
        switch (requestDTO.getRequestType()) {
            case SMSMESSAGING:
                ...
                requestHandler = SMSRequestFactoryHub.getInstance(requestDTO);
                break;
            default:
