...
public class RetrieveAccountStatusConfigRequestHandler extends AbstractRequestHandler<RetrieveAccountStatusConfigRequestWrapper>{
	...
	protected boolean validate(RetrieveAccountStatusConfigRequestWrapper wrapperDTO)
		...
		try {
			ValidationRule[] validationRules = { new ValidationRule(ValidationRule.VALIDATION_TYPE_MANDATORY,"apiType", apiType),
	...
	@Override
	protected Returnable process(RetrieveAccountStatusConfigRequestWrapper extendedRequestDTO)
			throws Exception {
	...
	@Override
	protected void init(RetrieveAccountStatusConfigRequestWrapper extendedRequestDTO)
			throws Exception {
